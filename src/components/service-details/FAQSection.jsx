...
export function FAQSection({ service, className }) {
        ...
        <div ref={containerRef} className="flex flex-col">
          <Accordion className="w-full">
            {service.faqs.map((faq, idx) => (
              ...
              >
                <AccordionTrigger className="text-xl font-bold font-heading text-[#09090B] hover:text-[#C5A059] hover:no-underline text-left">
                  {faq.question}
                </AccordionTrigger>
