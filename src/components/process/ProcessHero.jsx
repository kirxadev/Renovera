...
export function ProcessHero({ className }) {
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
        <div ref={contentRef} className="max-w-[800px] mx-auto flex flex-col items-center">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold font-heading tracking-tight leading-[1.1] text-white mb-8">
            From Vision{" "}
            <span className="italic font-light text-[#C5A059]">To Reality.</span>
          </h1>

          <p className="text-lg md:text-xl text-white/80 leading-relaxed font-medium max-w-[700px]">
            Every successful renovation begins with a thoughtful process. From the first consultation to the final handover, we ensure precision, transparency, and exceptional craftsmanship at every stage.
          </p>
        </div>
      </div>
    </section>
